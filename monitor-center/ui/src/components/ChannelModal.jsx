  ...
  return (
    <Modal show={showModal} onHide={handleCloseModal}>
      <Modal.Header closeButton>
        <Modal.Title>{channel.id ? 'Edit Channel' : 'Insert Channel'}</Modal.Title>
      </Modal.Header>
      <Modal.Body>
        <Form>
      ...
      <Modal.Footer>
        ...
        <Button type="submit" variant="primary" onClick={()=>handleSaveChannel(channel)}>
          Save
        </Button>
      </Modal.Footer>
    </Modal>
